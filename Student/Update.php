...
<body>
<form name="frmUser" method="post" action="" id="updateForm">
...
<input style="width: 50%; height:30px; margin-top:30px " type="submit" name="submit" value="Submit" class="buttom" onclick="hideForm()">
</section>
